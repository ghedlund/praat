...
PRAAT_LIB_EXPORT autoTable Table_createWithColumnNames (long numberOfRows, const char32 *columnNames);
PRAAT_LIB_EXPORT void Table_initWithoutColumnNames (Table me, long numberOfRows, long numberOfColumns);
PRAAT_LIB_EXPORT autoTable Table_createWithoutColumnNames (long numberOfRows, long numberOfColumns);
#define Table_create Table_createWithoutColumnNames

PRAAT_LIB_EXPORT autoTable Tables_append (OrderedOf<structTable>* me);
...
PRAAT_LIB_EXPORT void Table_insertColumn (Table me, long column, const char32 *label /* cattable */);
PRAAT_LIB_EXPORT void Table_setColumnLabel (Table me, long column, const char32 *label /* cattable */);
PRAAT_LIB_EXPORT long Table_findColumnIndexFromColumnLabel (Table me, const char32 *label) noexcept;
...
PRAAT_LIB_EXPORT long Table_searchColumn (Table me, long column, const char32 *value) noexcept;
...
PRAAT_LIB_EXPORT autoTable Table_readFromCharacterSeparatedTextFile (MelderFile file, char32 separator);

PRAAT_LIB_EXPORT autoTable Table_extractRowsWhereColumn_number (Table me, long column, int which_Melder_NUMBER, double criterion);
PRAAT_LIB_EXPORT autoTable Table_extractRowsWhereColumn_string (Table me, long column, int which_Melder_STRING, const char32 *criterion);
PRAAT_LIB_EXPORT autoTable Table_collapseRows (Table me, const char32 *factors_string, const char32 *columnsToSum_string,
...
PRAAT_LIB_EXPORT autoTable Table_rowsToColumns (Table me, const char32 *factors_string, long columnToTranspose, const char32 *columnsToExpand_string);
...
PRAAT_LIB_EXPORT const char32 * Table_getColStr (Table me, long columnNumber);
PRAAT_LIB_EXPORT double Table_getMatrix (Table me, long rowNumber, long columnNumber);
PRAAT_LIB_EXPORT const char32 * Table_getMatrixStr (Table me, long rowNumber, long columnNumber);
PRAAT_LIB_EXPORT double Table_getColIndex  (Table me, const char32 *columnLabel);
#endif
