...
double Ltas_convertStandardToSpecialUnit (Ltas me, double value, integer ilevel, int unit) 
	{ return my v_convertStandardToSpecialUnit(value, ilevel, unit); }
double Ltas_convertSpecialToStandardUnit (Ltas me, double value, integer ilevel, int unit)
