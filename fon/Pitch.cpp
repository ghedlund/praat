...
int Pitch_getMinimumUnit (Pitch me, integer ilevel) {
	return my v_getMinimumUnit(ilevel);
}


int Pitch_getMaximumUnit (Pitch me, integer ilevel) {
	return my v_getMaximumUnit(ilevel);
}

conststring32 Pitch_getUnitText (Pitch me, integer ilevel, int unit, uint32 flags) {
	return my v_getUnitText(ilevel, unit, flags);
}

bool Pitch_isUnitLogarithmic (Pitch me, integer ilevel, int unit) {
	return my v_isUnitLogarithmic(ilevel, unit);
}

double Pitch_convertStandardToSpecialUnit (Pitch me, double value, integer ilevel, int unit) {
	return my v_convertStandardToSpecialUnit(value, ilevel, unit);
}

double Pitch_convertSpecialToStandardUnit (Pitch me, double value, integer ilevel, int unit) {
